 ...
 */
package es.cifpcm.imageneslleomiranda.servlets;

import es.cifpcm.imageneslleomiranda.datasource.DbManager;
...
public class ReservaServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Hotel hotel = DbManager.get(codigo);
            int total = hotel.getPrecio() * noches;
            ...
            request.setAttribute("mensaje", "Hotel no encontrado");
